...
const NotClearedIncidents = () => {
  ...
  const notClearedIncidents = filteredIncidents.filter(
  ...
  return (
    <SideBarWrapper menuList={DashboardMenuList}>
      ...
      <IncidentAndServiceGrid data={notClearedIncidents} />
    </SideBarWrapper>
  );
};

export default NotClearedIncidents;
