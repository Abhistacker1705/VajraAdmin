...
const ClearedServices = () => {
  ...
  const clearedServices = filteredServices.filter(
    (assets) => assets.Status === "Cleared"
  );
  return (
    <SideBarWrapper menuList={DashboardMenuList}>
      ...
      <Box
        ...
        {clearedServices?.map((request, index) => (
          <Link
            key={index}
            href={
            ...
            <Box
              width="445px"
              height="257px"
              display={{xl: "inline-block", lg: "inline-block"}}
              paddingX="20px"
              paddingY="20px">
              <Grid>
                <Card
...
export default ClearedServices;
