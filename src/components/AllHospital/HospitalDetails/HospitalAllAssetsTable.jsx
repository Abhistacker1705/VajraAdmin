                ...
                <Table
                  ...
                  <TableHead sx={{width: "100vw", bgcolor: "#1746A233"}}>
                    <TableRow>
                      ...
                      <TableCell sx={{color: "#1746A2"}}>Asset Name</TableCell>
                      <TableCell sx={{color: "#1746A2"}}>Asset Code</TableCell>
                      <TableCell sx={{color: "#1746A2"}}>Serial No</TableCell>
                      <TableCell sx={{color: "#1746A2"}}>Model No</TableCell>
                      <TableCell sx={{color: "#1746A2"}}>Department</TableCell>
                      <TableCell sx={{color: "#1746A2"}}>
                        Department ID
                      </TableCell>
                      <TableCell sx={{color: "#1746A2"}}>Asset Type</TableCell>
                      <TableCell sx={{color: "#1746A2"}}>
                        Asset Status
                      </TableCell>
                      <TableCell sx={{color: "#1746A2"}}>
                    ...
                    {csvData?.map((request, index) => (
                      <TableRow
                        ...
                        <TableCell
                          ...
                          {rowIndex === index && columnName === "asset_name" ? (
                            <input
                              datatype="asset_name"
                        ...
                        <TableCell
                          ...
                          {rowIndex === index && columnName === "asset_code" ? (
                            <input
                              datatype="asset_code"
                        ...
                        <TableCell
                          ...
                          {rowIndex === index && columnName === "serial_no" ? (
                            <input
                              datatype="serial_no"
                        ...
                        <TableCell
                          ...
                          {rowIndex === index && columnName === "department" ? (
                            <input
                              datatype="department"
                        ...
                        <TableCell
                          ...
                          {rowIndex === index && columnName === "asset_type" ? (
                            <input
                              datatype="asset_type"
                        ...
                        <TableCell
                          ...
                          columnName === "warranty_exp_date" ? (
                            <input
                              datatype="warranty_exp_date"
                              value={editedCsvData[index]["warranty_exp_date"]}
                              onChange={(e) =>
                                handleEditCsvData(
                                  e.target.value,
                                  index,
